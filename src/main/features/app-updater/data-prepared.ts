...
import { UpdaterCopyProgress } from '@localtypes/index';
import path from 'path';
import fs from 'fs-extra';
import { APP_NAME } from '@root/utils/constants';
import { getAssetDatasPath } from '@root/sys';
import custom_documents from '@main/message-control/handlers/custom_documents';
